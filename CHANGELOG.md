...
### Added
- Mobile navigation: fixed top bar + slide-over drawer below 768px, with theme toggle and sign-out; the app is now fully navigable on phones.
...
### Fixed
- Mobile-width layout bugs: calendar day view no longer forces horizontal scroll; long patient contact values wrap instead of overflowing; the chat dock stays on-screen at phone widths.
